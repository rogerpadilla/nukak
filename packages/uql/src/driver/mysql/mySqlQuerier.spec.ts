...
class MySqlQuerierSpec implements Spec {
  ...
  async shouldFind() {
    ...
    expect(this.querier.beginTransaction).not.toBeCalled();
    expect(this.querier.commitTransaction).not.toBeCalled();
    expect(this.querier.rollbackTransaction).not.toBeCalled();
    expect(this.querier.release).not.toBeCalled();
  }
