...
export interface SchemaGenerator {
   ...
   */
  getSqlType(fieldOptions: import('@uql/core/type').FieldOptions, fieldType?: unknown): string;
   ...
   */
  resolveColumnName(key: string, field: import('@uql/core/type').FieldOptions): string;
}
