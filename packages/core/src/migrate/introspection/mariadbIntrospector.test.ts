...
/**
 * MariaDB Schema Introspector Integration Tests
 *
 * Runs against a real MariaDB database (docker-compose service).
 ...
 * - MariaDB-specific features (DECIMAL precision, TINYINT booleans)
 */
class MariadbIntrospectorIt extends AbstractIntrospectorIt {
  constructor() {
  ...
  // ============================================================================
  // MariaDB-Specific Hooks
  // ============================================================================

  /**
   * MariaDB requires disabling FK checks before dropping tables.
   */
