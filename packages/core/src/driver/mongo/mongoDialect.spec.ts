...
class MongoDialectSpec implements Spec {
  ...
  shouldBuildFilter() {
    ...
    expect(
      this.dialect.buildFilter<Item>(Item, { id: new ObjectId('507f191e810c19729de860ea') as any })
    ).toEqual({ _id: new ObjectId('507f191e810c19729de860ea') });
    ...
    expect(
      this.dialect.buildFilter<TaxCategory>(TaxCategory, { pk: new ObjectId('507f191e810c19729de860ea') as any })
    ).toEqual({ _id: new ObjectId('507f191e810c19729de860ea') });
  }
