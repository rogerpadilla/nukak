type Callable<A extends abstract new () => any> = A extends new (...args: infer Args) => infer Instance
 ...
 * @private
 */
export function classToInvokable<Class extends new (...args: any[]) => any>(constructor: Class): Callable<Class> {
