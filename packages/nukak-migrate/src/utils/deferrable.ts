import { classToInvokable } from './class-to-invokable.js';
import { EMPTY_ARRAY } from './object.js';
...
export class ConstraintChecking {
  ...
  static readonly DEFERRED = classToInvokable(
    class DEFERRED extends ConstraintChecking {
      ...
      override isEqual(other: unknown): boolean {
        return other instanceof DEFERRED && Object.is(this.#constraints, other.#constraints);
      }

      override get constraints(): readonly string[] {
  ...
  static readonly IMMEDIATE = classToInvokable(
    class IMMEDIATE extends ConstraintChecking {
      ...
      override isEqual(other: unknown): boolean {
        return other instanceof IMMEDIATE && Object.is(this.#constraints, other.#constraints);
      }
