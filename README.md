...
[nukak](https://nukak.org) is the <a href="https://medium.com/@rogerpadillac/in-search-of-the-perfect-orm-e01fcc9bce3d" target="_blank">smartest ORM</a> for TypeScript, it is designed to be fast, safe, and easy to integrate into any application. It takes inspiration from [Mongo queries](https://www.mongodb.com/docs/drivers/node/current/fundamentals/crud/query-document/){:target="\_blank"}.
