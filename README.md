...
Uses a consistent API for distinct databases, including PostgreSQL, MySQL, MariaDB, SQLite, LibSQL, Neon, Cloudflare D1, and even MongoDB (inspired by MongoDB glorious syntax).
